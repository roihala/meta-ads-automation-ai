...
10-25 creatives that vary on 3 real dimensions × 3 options = 27 combinations beat 50 near-duplicates. Diversity is *material* (hook, subject, format, offer), not *cosmetic* (color, font).
